...
public class CardConfigurator {
	...
	public static function initCharacterCards( v:Vector.<Array> ) : void {
		...
		const ROLE_FIELDS:Array = ["id", "name", "camp", "type", "subType", "quality", "mana", "attack", "hp", "movement", "gender", null, null, "skill1", "skill2", "skill3", null, "imageURL", null, "effectURL", "soundURL", "desc", null ];	
		l = v.length;
		while(i<l){
	...
	public static function initEquipmentCards( v:Vector.<Array> ) : void {
		...
		const EQUIPMENT_FIELDS:Array = ["id", "name", "camp", "quality", "type", "sort", null, "usage", "mana", "costResType", "costCondition", "costCount", null, null, null, "carryMax", "skill1", "skill2", "imageURL", "buffIconURL", "effectURL", "soundURL", "desc" ];
		l = v.length;
		while(i<l){
	 ...
	 * @param id
	 */
	public static function getCardById( id:int ) : CardCfg {
		return _cardList[id];
	}
